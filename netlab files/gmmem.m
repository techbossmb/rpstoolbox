...
%   Modifications:
%   Tunde added  line 115 to return the prb matrix that a pt belonging to a k-th pdf
...
for n = 1:niters
  ...
  new_pr = sum(post, 1);
  new_c = post' * x;
  %% tunde - added line to return the prb matrix that a pt belonging to a k-th pdf
  mix.prob_matrix = post;
  %% end tunde added
